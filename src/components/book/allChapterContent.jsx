...
export const CHAPTER_CONTENT = {
  ...
  "bills-story": {
    ...
    paragraphs: [
      ...
      { text: 'Trembling, I stepped from the hospital a broken man. Fear sobered me for a bit. Then came the insidious insanity of that first drink. How dark it is before the dawn! In reality that was the beginning of my last debauch. I was soon to be catapulted into what I like to call the fourth dimension of existence.', highlight: 'blue' },
      ...
      { text: 'But my friend sat before me, and he made the point-blank declaration that God had done for him what he could not do for himself. His human will had failed. Doctors had pronounced him incurable. Then he had, in effect, been raised from the dead, suddenly taken from the scrap heap to a level of life better than the best he had ever known!', highlight: 'blue' },
      { text: 'My friend suggested what then seemed a novel idea. He said, why don\'t you choose your own conception of God? That statement hit me hard. It melted the icy intellectual mountain in whose shadow I had lived and shivered many years. I stood in the sunlight at last.', highlight: 'orange' },
      { text: 'At the hospital I was separated from alcohol for the last time. There I humbly offered myself to God, as I then understood Him, to do with me as He would. I placed myself unreservedly under His care and direction.', highlight: 'orange' },
      { text: 'My schoolmate visited me, and I fully acquainted him with my problems and deficiencies. We made a list of people I had hurt or toward whom I felt resentment. I expressed my entire willingness to approach these individuals, admitting my wrong.', highlight: 'orange' },
      { text: 'I was to test my thinking by the new God-consciousness within. I was to sit quietly when in doubt, asking only for direction and strength to meet my problems as He would have me.', highlight: 'green' },
      { text: 'Simple, but not easy; a price had to be paid. It meant destruction of self-centeredness. These were revolutionary and drastic proposals, but the moment I fully accepted them, the effect was electric. There was a sense of victory, followed by such a peace and serenity as I had never known.', highlight: 'blue' },
      { text: 'While I lay in the hospital the thought came that there were thousands of hopeless alcoholics who might be glad to have what had been so freely given me. Perhaps I could help some of them. They in turn might work with others.', highlight: 'yellow' },
      { text: 'My wife and I abandoned ourselves with enthusiasm to the idea of helping other alcoholics to a solution of their problems. Many times I have gone to my old hospital in despair. On talking to a man there, I would be amazingly lifted up and set on my feet.', highlight: 'yellow' },
  ...
  "there-is-solution": {
    ...
    paragraphs: [
      ...
      { text: "But the ex-problem drinker who has found this solution, who is properly armed with facts about himself, can generally win the entire confidence of another alcoholic in a few hours. Until such an understanding is reached, little or nothing can be accomplished.", highlight: "yellow" },
      { text: "That the man who is making the approach has had the same difficulty, that he obviously knows what he is talking about, that his whole deportment shouts at the new prospect that he is a man with a real answer, that he has no attitude of Holier Than Thou, nothing whatever except the sincere desire to be helpful; that there are no fees to pay, no axes to grind, no people to please, no lectures to be endured—these are the conditions we have found most effective.", highlight: "yellow" },
      ...
      { text: "But what about the real alcoholic? He may start off as a moderate drinker; he may or may not become a continuous hard drinker; but at some stage of his drinking career he begins to lose all control of his liquor consumption, once he starts to drink.", highlight: "yellow" },
      ...
      { text: "There is a solution. Almost none of us liked the self-searching, the leveling of our pride, the confession of shortcomings which the process requires for its successful consummation. But we saw that it really worked in others, and we had come to believe in the hopelessness and futility of life as we had been living it.", highlight: "blue" },
      { text: "The great fact is just this, and nothing less: That we have had deep and effective spiritual experiences which have revolutionized our whole attitude toward life, toward our fellows and toward God's universe. The central fact of our lives today is the absolute certainty that our Creator has entered into our hearts and lives in a way which is indeed miraculous.", highlight: "blue" },
      { text: "If you are as seriously alcoholic as we were, we believe there is no middle-of-the-road solution. We were in a position where life was becoming impossible, and if we had passed into the region from which there is no return through human aid, we had but two alternatives: One was to go on to the bitter end, blotting out the consciousness of our intolerable situation as best we could; and the other, to accept spiritual help.", highlight: "blue" }
    ]
  },
  ...
  "more-about-alcoholism": {
    ...
    paragraphs: [
      { text: "Most of us have been unwilling to admit we were real alcoholics. No person likes to think he is bodily and mentally different from his fellows. Therefore, it is not surprising that our drinking careers have been characterized by countless vain attempts to prove we could drink like other people.", highlight: "yellow" },
      { text: "The idea that somehow, someday he will control and enjoy his drinking is the great obsession of every abnormal drinker. The persistence of this illusion is astonishing. Many pursue it into the gates of insanity or death.", highlight: "yellow" },
      { text: "We learned that we had to fully concede to our innermost selves that we were alcoholics. This is the first step in recovery. The delusion that we are like other people, or presently may be, has to be smashed.", highlight: "orange" },
      { text: "We alcoholics are men and women who have lost the ability to control our drinking. We know that no real alcoholic ever recovers control. All of us felt at times that we were regaining control, but such intervals—usually brief—were inevitably followed by still less control, which led in time to pitiful and incomprehensible demoralization.", highlight: "yellow" },
      ...
      { text: '"As soon as I regained my ability to think, I went carefully over that evening in Washington. Not only had I been off guard, I had made no fight whatever against the first drink. This time I had not thought of the consequences at all. I had commenced to drink as carelessly as though the cocktails were ginger ale."', highlight: "yellow" },
      ...
      { text: '"Then they outlined the spiritual answer and program of action which a hundred of them had followed successfully. The moment I made up my mind to go through with the process, I had the curious feeling that my alcoholic condition was relieved, as in fact it proved to be."', highlight: "blue" },
      { text: "Once more: The alcoholic at certain times has no effective mental defense against the first drink. Except in a few rare cases, neither he nor any other human being can provide such a defense. His defense must come from a Higher Power.", highlight: "blue" }
    ]
  },
  ...
  "we-agnostics": {
    ...
    paragraphs: [
      ...
      { text: 'My friend suggested what then seemed a novel idea. He said, "Why don\'t you choose your own conception of God?" That statement hit me hard. It melted the icy intellectual mountain in whose shadow I had lived and shivered many years. I stood in the sunlight at last.', highlight: "blue" },
      { text: "Much to our relief, we discovered we did not need to consider another's conception of God. Our own conception, however inadequate, was sufficient to make the approach and to effect a contact with Him. As soon as we admitted the possible existence of a Creative Intelligence, a Spirit of the Universe underlying the totality of things, we began to be possessed of a new sense of power and direction.", highlight: "blue" },
      { text: "When, therefore, we speak to you of God, we mean your own conception of God. This applies, too, to other spiritual expressions which you find in this book. Do not let any prejudice you may have against spiritual terms deter you from honestly asking yourself what they mean to you.", highlight: "blue" },
      { text: 'We needed to ask ourselves but one short question. "Do I now believe, or am I even willing to believe, that there is a Power greater than myself?" As soon as a man can say that he does believe, or is willing to believe, we emphatically assure him that he is on his way.', highlight: "orange" },
      ...
      { text: "On one proposition, however, these men and women are strikingly agreed. Every one of them has gained access to, and believes in, a Power greater than himself. This Power has in each case accomplished the miraculous, the humanly impossible.", highlight: "blue" },
      { text: "Here are thousands of men and women, worldly indeed. They flatly declare that since they have come to believe in a Power greater than themselves, to take a certain attitude toward that Power, and to do certain simple things, there has been a revolutionary change in their way of living and thinking.", highlight: "blue" },
      { text: "When we saw others solve their problems by a simple reliance upon the Spirit of the Universe, we had to stop doubting the power of God. Our ideas did not work. But the God idea did.", highlight: "blue" },
      ...
      { text: "When we became alcoholics, crushed by a self-imposed crisis we could not postpone or evade, we had to fearlessly face the proposition that either God is everything or else He is nothing. God either is, or He isn't. What was our choice to be?", highlight: "blue" },
      ...
      { text: 'Then, like a thunderbolt, a great thought came. It crowded out all else: "Who are you to say there is no God?" This man recounts that he tumbled out of bed to his knees. In a few seconds he was overwhelmed by a conviction of the Presence of God. It poured over and through him with the certainty and majesty of a great tide at flood.', highlight: "blue" },
      { text: "Thus was our friend's cornerstone fixed in place. No later vicissitude has shaken it. His alcoholic problem was taken away. That very night, years ago, it disappeared. Save for a few brief moments of temptation the thought of drink has never returned; and at such times a great revulsion has risen up in him. Seemingly he could not drink even if he would. God had restored his sanity.", highlight: "blue" },
      { text: "What is this but a miracle of healing? Yet its elements are simple. Circumstances made him willing to believe. He humbly offered himself to his Maker—then he knew. Even so has God restored us all to our right minds. To this man, the revelation was sudden. Some of us grow into it more slowly. But He has come to all who have honestly sought Him. When we drew near to Him He disclosed Himself to us!", highlight: "blue" }
    ]
  },
  ...
  "the-perpetual-quest": {
    ...
    paragraphs: [
      ...
      { text: 'Late that night at home, there was a presence in the room with me, even though I lived alone. The next morning I knew I didn\'t have to drink.', highlight: 'blue' },
      ...
      { text: 'The hardest thing I had to deal with in sobriety was my own anger and the violence I lived through in my childhood. I would never have recovered from violence and alcoholism without A.A.\'s Twelve Steps.', highlight: 'blue' },
  ...
  "a-drunk-like-you": {
    ...
    paragraphs: [
      ...
      { text: 'On the plane I said, "Yes" to drinks. I drank for the whole flight. As we approached our destination, I found my ninety-day pocket piece. Wow, those guys at the meeting were right—I am powerless over alcohol.', highlight: 'blue' },
      { text: 'I put that coin back in my pocket and from that day to this, some 15½ years later, I have had no urge to drink. When I got back to my meeting, I told them what had happened.', highlight: 'blue' },
      ...
      { text: 'I arrived at the meeting and no one else was there. Then a man walked through the door. He suggested we have a meeting. For the next forty-five minutes I talked. I made completely honest contact with another human being.', highlight: 'blue' },
      { text: 'When I had finished, he told me something simple: "You don\'t have to drink over it." Here was a man telling me that, independent of my life situation, I did not have to drink. He gave me hope.', highlight: 'blue' }
    ]
  },
  ...
  "acceptance-was-the-answer": {
    ...
    paragraphs: [
      ...
      { text: 'Today, I find I can\'t work my A.A. program while taking pills. I can\'t say, "Thy will be done," and take a pill. Giving up alcohol alone was not enough; I\'ve had to give up all mood- and mind-affecting chemicals.', highlight: 'orange' },
      ...
      { text: 'In the hospital I hung on to the idea that if I could just control the external environment, the internal environment would become comfortable. Today we have turned our wills and lives over to the care of God.', highlight: 'orange' },
      ...
      { text: 'Finally, after seven months, I decided to try it. I am amazed at how many of my problems have become manageable or have simply disappeared since I quit drinking.', highlight: 'blue' },
      ...
      { text: 'At last, acceptance proved to be the key to my drinking problem. After seven months, I was finally able to say, "Okay, God. I really am an alcoholic. And it\'s all right with me. Now, what am I going to do about it?"', highlight: 'blue' },
      { text: 'When I stopped living in the problem and began living in the answer, the problem went away. From that moment on, I have not had a single compulsion to drink.', highlight: 'blue' },
      { text: 'And acceptance is the answer to all my problems today. When I am disturbed, it is because I find some person, place, thing, or situation unacceptable to me, and I can find no serenity until I accept that it is exactly the way it is supposed to be at this moment.', highlight: 'blue' },
      { text: 'Nothing, absolutely nothing, happens in God\'s world by mistake. Until I could accept my alcoholism, I could not stay sober; unless I accept life completely on life\'s terms, I cannot be happy.', highlight: 'blue' },
      { text: 'I need to concentrate not so much on what needs to be changed in the world as on what needs to be changed in me and in my attitudes.', highlight: 'yellow' },
      ...
      { text: 'For years I was sure the worst thing that could happen would be that I would turn out to be an alcoholic. Today I find it\'s the best thing that has ever happened to me.', highlight: 'blue' }
    ]
  },
  ...
  "window-of-opportunity": {
    ...
    paragraphs: [
      ...
      { text: 'One definition of a bottom is the point when the last thing you lost or the next thing you are about to lose is more important to you than booze. For me, it was clear. I was willing to do anything to get back into school.', highlight: 'yellow' },
      ...
      { text: 'Then a woman introduced herself and said she was an alcoholic. She spoke about feelings, of insecurity replaced by confidence, fear replaced by faith, resentment replaced by love, and despair replaced by joy.', highlight: 'blue' },
      { text: 'After the meeting, people welcomed me with open arms and gave me their telephone numbers. The speaker said, "If you\'re an apple, you can be the best apple you can be, but you can never be an orange." I was an apple all right, and for the first time I understood I had spent my life trying to be an orange.', highlight: 'blue' },
      ...
      { text: 'He asked me how I was doing. The pain, fear, misery, anger, loss, resentment, and despair came pouring out. For the first time I made completely honest contact with another human being. I was met with acceptance and love.', highlight: 'blue' },
      { text: 'When I had finished, he told me something simple: "You don\'t have to drink over it." If I stuck with A.A., I could stay sober under any and all conditions. He gave me hope.', highlight: 'blue' },
      { text: 'I began to change. I began to pray. I became actively involved in working the steps. I began working with a sponsor and became active in my home group. My life began to change.', highlight: 'blue' },
      ...
      { text: 'After some time my sponsor asked: "These people who aren\'t doing it right, are they staying sober?" I admitted they were. "Now it\'s time for you to listen to figure out how they are staying sober." Slowly but surely, some wisdom and humility began to creep in.', highlight: 'yellow' },
      { text: 'I was fortunate to spend time abroad during law school. I have been in meetings in probably a dozen countries and have always been amazed at the message that transcends all differences. There is a solution. Together, we can live soberly, joyously, and freely.', highlight: 'blue' },
      ...
      { text: 'I was married shortly after my ninth anniversary. One week before my twelfth anniversary, our son was born. Through him I learned more about unconditional love, the value of wonder, and the sheer joy of being alive.', highlight: 'blue' },
      { text: 'I once knew a woman who was crying before a meeting. She was approached by a five-year-old girl who told her, "You don\'t have to cry here. This is a good place. They took my daddy and they made him better." That is exactly what A.A. did for me.', highlight: 'blue' }
    ]
  }
};