export const appendicesContent = {
  ...
  paragraphs: [
    ...
    { text: "2. For our group purpose there is but one ultimate authority—a loving God as He may express Himself in our group conscience. Our leaders are but trusted servants; they do not govern." },
    { text: "3. The only requirement for A.A. membership is a desire to stop drinking." },
    { text: "4. Each group should be autonomous except in matters affecting other groups or A.A. as a whole." },
    { text: "5. Each group has but one primary purpose—to carry its message to the alcoholic who still suffers." },
    { text: "6. An A.A. group ought never endorse, finance, or lend the A.A. name to any related facility or outside enterprise, lest problems of money, property, and prestige divert us from our primary purpose." },
    { text: "7. Every A.A. group ought to be fully self-supporting, declining outside contributions." },
    { text: "8. Alcoholics Anonymous should remain forever nonprofessional, but our service centers may employ special workers." },
    { text: "9. A.A., as such, ought never be organized; but we may create service boards or committees directly responsible to those they serve." },
    ...
    { text: "Dr. Silkworth's theory of alcoholism as an allergy combined with an obsession has stood the test of time. Modern medicine recognizes alcoholism as a disease with physical, mental, and spiritual components. The A.A. approach addresses all three." },
    { text: "A.A. AND THE FAMILY" },
    { text: "The family of the alcoholic suffers terribly. We hope this book has made clear that alcoholism is a family illness. The entire family has been affected—emotionally, sometimes physically, and certainly spiritually." },
    { text: "When the alcoholic member gets sober, the family often needs time to heal as well. Resentments may linger. Trust must be rebuilt. The spouse and children may have developed their own dysfunctional patterns of coping." },
    { text: "We have found that patience, understanding, and living the program principles in all our affairs helps the family to heal. Many families attend Al-Anon, a fellowship for families and friends of alcoholics, which uses principles similar to those in A.A." },
    { text: "A.A. TRADITION - HOW IT DEVELOPED" },
    { text: "A.A. has no rules or regulations. We are not organized in the formal sense. Yet we have found that certain principles, when followed, help us to work together effectively and to grow as a fellowship." },
    { text: "These principles, now known as the Twelve Traditions, evolved from our experience. They are suggestions only, yet most groups have found that they need them to survive and to serve their primary purpose—carrying the message to the alcoholic who still suffers." },
    { text: "The Traditions protect A.A. from internal strife and outside interference. They help us remain unified in our common purpose while respecting the autonomy of each group. They keep us focused on our primary purpose and free from outside entanglements." },
    { text: "PROBLEMS OTHER THAN ALCOHOL" },
