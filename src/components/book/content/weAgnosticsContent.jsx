export const weAgnosticsContent = {
  paragraphs: [
    ...
    {
      segments: [
        { text: `To one who feels he is an atheist or agnostic such an experience seems impossible, but to continue as he is means disaster, especially if he is an alcoholic of the hopeless variety. ` },
        { text: `To be doomed to an alcoholic death or to live on a spiritual basis`, highlight: 'pink' },
        { text: ` are not always easy alternatives to face.` }
      ]
    },
    {
    ...
    {
      segments: [
        { text: `Lack of power`, highlight: 'pink' },
        { text: `, that was our dilemma. We had to find a power by which we could live, and it had to be a ` },
        { text: `Power greater than ourselves`, highlight: 'pink' },
        { text: `. Obviously. But where and how were we to find this Power?` }
      ]
    },
    {
      segments: [
        { text: `Well, that's exactly ` },
        { text: `what this book is about. Its main object is to enable you to find a Power greater than yourself which will solve your problem.`, highlight: 'pink' },
    ...
    {
      segments: [
        { text: `When, therefore, we speak to you of God, we mean ` },
        { text: `your own conception of God`, highlight: 'pink' },
    ...
    {
      segments: [
        { text: `We needed to ask ourselves but one short question. ` },
        { text: `"Do I now believe, or am I even willing to believe, that there is a Power greater than myself?"`, highlight: 'pink' },
        { text: ` ` },
        { text: `As soon as a man can say that he does believe, or is willing to believe, we emphatically assure him that he is on his way. It has been repeatedly proven among us that upon this simple `, highlight: 'blue' },
        { text: `cornerstone`, highlight: 'pink' },
        { text: ` a wonderfully effective spiritual structure can be built.*`, highlight: 'blue' }
      ]
    },
    {
    ...
    {
      segments: [
        { text: `We had to ask ourselves why we shouldn't apply to our human problems this same readiness to change our point of view. ` },
        { text: `We were having trouble with personal relationships, we couldn't control our emotional natures, we were a prey to misery and depression, we couldn't make a living, we had a feeling of uselessness, we were full of fear, we were unhappy, we couldn't seem to be of real help to other people—was not a basic solution of these `, highlight: 'pink' },
        { text: `bedevilments`, highlight: 'yellow' },
        { text: ` more important than whether we should see newsreels of lunar flight? Of course it was.`, highlight: 'pink' }
      ]
    },
    {
    ...
    {
      segments: [
        { text: `We can only clear the ground a bit. If our testimony helps sweep away prejudice, enables you to think honestly, encourages you to search diligently within yourself, then, if you wish, you can join us on the Broad Highway. ` },
        { text: `With this attitude you cannot fail. The consciousness of your belief is sure to come to you.`, highlight: 'blue' }
      ]
    },
    {
      segments: [
        { text: `In this book you will read the experience of a man who thought he was an ` },
        { text: `atheist`, highlight: 'pink' },
        { text: `. His story is so interesting that some of it should be told now. His change of heart was dramatic, convincing, and moving.` }
      ]
    },
    { pageNum: "56" },
    {
    ...
    {
      segments: [
        { text: `This man recounts that he tumbled out of bed to his knees. In a few seconds he was overwhelmed by a conviction of the Presence of God. It poured over and through him with the certainty and majesty of a great tide at flood. The barriers he had built through the years were swept away. He stood in the Presence of Infinite Power and Love. He had stepped from bridge to shore. For the first time, he lived in conscious companionship with his Creator.`, highlight: 'blue' }
      ]
    },
    {
      segments: [
        { text: `Thus was our friend's cornerstone fixed in place. No later vicissitude has shaken it. His alcoholic problem was taken away. That very night, years ago, it disappeared.`, highlight: 'blue' }
      ]
    },
    { pageNum: "57" },
    {
      segments: [
        { text: `Save for a few brief moments of temptation the thought of drink has never returned; and at such times a great revulsion has risen up in him. Seemingly he could not drink even if he would. God had restored his sanity.`, highlight: 'blue' }
      ]
    },
    {
      segments: [
        { text: `What is this but a miracle of healing? Yet its elements are simple. Circumstances made him willing to believe. He humbly offered himself to his Maker—then he knew.`, highlight: 'blue' }
      ]
    },
    {
      segments: [
        { text: `Even so has God restored us all to our right minds. To this man, the revelation was sudden. Some of us grow into it more slowly. But He has come to all who have honestly sought Him.`, highlight: 'blue' }
      ]
    },
    {
      segments: [
