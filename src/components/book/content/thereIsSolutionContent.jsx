  ...
  paragraphs: [
    ...
    { text: `Of necessity there will have to be discussion of matters medical, psychiatric, social, and religious. We are aware that these matters are, from their very nature, controversial. Nothing would please us so much as to write a book which would contain no basis for contention or argument. We shall do our utmost to achieve that ideal. Most of us sense that real tolerance of other people's shortcomings and viewpoints and a respect for their opinions are attitudes which make us more useful to others. Our very lives, as ex-problem drinkers, depend upon our constant thought of others and how we may help meet their needs.` },
    {
      segments: [
        ...
        { text: `What do I have to do?`, highlight: 'pink' },
        { text: `"` }
      ]
    },
    {
      segments: [
        ...
        { text: ` to answer such questions specifically. We shall tell you what we have done. Before going into a detailed discussion, it may be well to summarize some points as we see them.` }
      ]
    },
    ...
    {
      segments: [
        { text: `The fact is that most alcoholics, for reasons yet obscure, have ` },
        { text: `lost the power of choice in drink.`, highlight: 'pink' },
        { text: ` Our so-called will power becomes practically nonexistent. We are unable, at certain times, to bring into our consciousness with sufficient force the memory of the suffering and humiliation of even a week or a month ago. ` },
        { text: `We are without defense against the first drink.`, highlight: 'pink' }
      ]
    },
    ...
    {
      segments: [
        { text: `If you are as seriously alcoholic as we were, we believe there is no middle-of-the-road solution. ` },
        { text: `We were in a position where life was becoming impossible, and if we had passed into the region from which there is no return through human aid, we had but two alternatives: One was to go on to the bitter end, blotting out the consciousness of our intolerable situation as best we could; and the other, to accept spiritual help.`, highlight: 'pink' },
        { text: ` This we did because we honestly wanted to, and were willing to make the effort.` }
      ]
    },
    { text: `*Fully explained-Appendix II.` },
    { pageNum: "23" },
    {
      segments: [
        { text: `` },
        { text: `A certain American business man had ability, good sense, and high character.`, highlight: 'pink' },
        { text: ` For years he had floundered from one sanitarium to another. He had consulted the best known American psychiatrists. Then he had gone to Europe, placing himself in the care of a celebrated physician (the psychiatrist, Dr. Jung) who prescribed for him. Though experience had made him skeptical, he finished his treatment with unusual confidence. His physical and mental condition were unusually good. Above all, he believed he had acquired such a ` },
        { text: `profound knowledge`, highlight: 'pink' },
        { text: ` of the inner workings of his mind and its hidden springs that relapse was unthinkable. Nevertheless, he was drunk in a short time. More baffling still, he could give himself no satisfactory explanation for his fall.` }
      ]
    },
    {
      segments: [
        ...
        { text: ` He seemed quite rational and well-balanced with respect to other problems. Yet he had ` },
        { text: `no control`, highlight: 'pink' },
        { text: ` whatever over alcohol. Why was this?` }
      ]
    },
    { pageNum: "24" },
    ...
    { text: `*For amplification-see Appendix II.` },
    { pageNum: "25" },
    ...
    { pageNum: "27" },
    {
      segments: [
        ...
        { text: `Further on, clear-cut directions are given showing how we recovered.`, highlight: 'pink' },
    ...
    { text: `Each individual, in the personal stories, describes in his own language and from his own point of view the way he established his relationship with God. These give a fair cross section of our membership and a clear-cut idea of what has actually happened in their lives.` },
    {
      segments: [
        ...
        { text: `Yes, I am one of them too; I must have this thing.`, highlight: 'pink' },
        { text: `"` }
      ]
    }
  ]
