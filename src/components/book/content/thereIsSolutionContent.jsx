  ...
  paragraphs: [
    { pageNum: "17" },
    {
      segments: [
        ...
        { text: `. They have solved the drink problem.`, highlight: 'pink' }
      ]
    },
    ...
    {
      segments: [
        { text: `The tremendous fact for every one of us is that we have discovered a `, highlight: 'pink' },
        { text: `common solution`, highlight: 'pink' },
        { text: `. We have a way out on which we can absolutely agree, and upon which we can join in brotherly and harmonious action. This is the great news this book carries to those who suffer from alcoholism.`, highlight: 'pink' }
      ]
    },
    {
      segments: [
        { text: `An illness`, highlight: 'pink' },
        { text: ` of this sort—and we have come to believe it ` },
        { text: `an illness`, highlight: 'pink' },
        { text: `—involves those about us in a way no other human sickness can. If a person has cancer all are sorry for him and no one is angry or hurt. But not so with the ` },
        { text: `alcoholic illness`, highlight: 'pink' },
        { text: `, for with it there goes annihilation of all the things worth while in life. It engulfs all whose lives touch the sufferer's. It brings misunderstanding, fierce resentment, financial insecurity, disgusted friends and employers, warped lives of blameless children, sad wives and parents—anyone can increase the list.` }
      ]
    },
    ...
    {
      segments: [
        { text: `But the ex-problem drinker who has found this solution, who is properly armed with facts about himself, can generally win the entire confidence of another alcoholic in a few hours. Until such an understanding is reached, little or nothing can be accomplished.`, highlight: 'pink' }
      ]
    },
    ...
    {
      segments: [
        { text: `You may already have asked yourself why it is that all of us became so very ill from drinking. Doubtless you are curious to discover how and why, in the face of expert opinion to the contrary, we have `, highlight: 'pink' },
        { text: `recovered`, highlight: 'pink' },
        { text: ` from a hopeless condition of mind and body. If you are an alcoholic who wants to get over it, you may already be asking—"What do I have to do?"`, highlight: 'pink' }
      ]
    },
    {
      segments: [
        { text: `It is the purpose of this book to answer such questions specifically. We shall tell you what we have done.`, highlight: 'pink' },
        { text: ` Before going into a detailed discussion, it may be well to summarize some points as we see them.` }
      ]
    },
    ...
    {
      segments: [
        { text: `Moderate drinkers`, highlight: 'pink' },
        { text: ` have little trouble in giving up liquor entirely if they have good reason for it. They can take it or leave it alone.` }
      ]
    },
    {
      segments: [
        { text: `Then we have a certain type of ` },
        { text: `hard drinker`, highlight: 'pink' },
    ...
    },
    {
      segments: [
        ...
        { text: `? He may start off as a ` },
        { text: `moderate drinker`, highlight: 'pink' },
        { text: `; he may or may not become a continuous ` },
        { text: `hard drinker`, highlight: 'pink' },
    ...
    {
      segments: [
        { text: `We know that while the alcoholic keeps away from drink, as he may do for months or years, he reacts much like other men. We are equally positive that once he takes any alcohol whatever into his system, something happens, both in the bodily and mental sense, which makes it `, highlight: 'pink' },
        { text: `virtually impossible for him to stop`, highlight: 'pink' },
        { text: `. The experience of any alcoholic will abundantly confirm this.` }
      ]
    },
    {
      segments: [
        { text: `These observations would be academic and pointless if our friend never took the first drink, thereby setting the terrible cycle in motion. `, highlight: 'pink' },
        { text: `Therefore, the main problem of the alcoholic centers in his mind, rather than in his body.`, highlight: 'pink' },
        { text: ` If you ask him why he started on that last bender, the chances are he will offer you any one of a hundred alibis. Sometimes these excuses have a certain plausibility, but none of them really makes sense in the light of the havoc an alcoholic's drinking bout creates. They sound like the philosophy of the man who, having a headache, beats himself on the head with a hammer so that he can't feel the ache. If you draw this fallacious reasoning to the attention of an alcoholic, he will laugh it off, or become irritated and refuse to talk.` }
      ]
    },
    ...
    {
      segments: [
        { text: `The tragic truth is that if the man be a ` },
        { text: `real alcoholic`, highlight: 'pink' },
        { text: `, the happy day may not arrive. He has lost control. At a certain point in the drinking of every alcoholic, he passes into a state where the most powerful desire to stop drinking is of absolutely no avail. This tragic situation has already arrived in practically every case long before it is suspected.` }
      ]
    },
    {
      segments: [
        { text: `The fact is that most alcoholics, for reasons yet obscure, have lost the power of choice in drink. Our so-called will power becomes practically nonexistent. We are unable, at certain times, to bring into our consciousness with sufficient force the memory of the suffering and humiliation of even a week or a month ago. We are without defense against the first drink.`, highlight: 'pink' }
      ]
    },
    ...
    {
      segments: [
        { text: `There is a solution.`, highlight: 'blue' },
    ...
    {
      segments: [
        { text: `The great fact is just this, and nothing less: That we have had `, highlight: 'blue' },
    ...
    {
      segments: [
        { text: `If you are as seriously alcoholic as we were, we believe there is no middle-of-the-road solution. We were in a position where life was becoming impossible, and if we had passed into the region from which there is no return through human aid, we had but ` },
        { text: `two alternatives: One was to go on to the bitter end, blotting out the consciousness of our intolerable situation as best we could; and the other, to accept spiritual help.`, highlight: 'blue' },
    ...
    { pageNum: "23" },
    {
      segments: [
        ...
        { text: ` had ability, good sense, and high character. For years he had floundered from one sanitarium to another. He had consulted the best known American psychiatrists. Then he had gone to Europe, placing himself in the care of a celebrated physician (the psychiatrist, Dr. Jung) who prescribed for him. Though experience had made him skeptical, he finished his treatment with unusual confidence. His physical and mental condition were unusually good. Above all, he believed he had acquired such a profound knowledge of the inner workings of his mind and its hidden springs that relapse was unthinkable. Nevertheless, he was drunk in a short time. More baffling still, he could give himself no satisfactory explanation for his fall.` }
      ]
    },
    {
      segments: [
        { text: `So he returned to this doctor, whom he admired, and asked him point-blank why he could not recover. He wished above all things to regain ` },
        { text: `self-control`, highlight: 'pink' },
    ...
    {
      segments: [
        { text: `"Yes," replied the doctor, "there is. Exceptions to cases such as yours have been occurring since early times. Here and there, once in a while, alcoholics have had what are called ` },
        { text: `vital spiritual experiences`, highlight: 'pink' },
        { text: `. To me these occurrences are phenomena. They appear to be in the nature of huge emotional displacements and rearrangements. Ideas, emotions, and attitudes which were once the guiding forces of the lives of these men are suddenly cast to one side, and a completely new set of conceptions and motives begin to dominate them. In fact, I have been trying to produce some such emotional rearrangement within you. With many individuals the methods which I employed are successful, but I have never been successful with an alcoholic of your description."` }
      ]
    },
    {
      segments: [
        { text: `Upon hearing this, our friend was somewhat relieved, for he reflected that, after all, he was a good church member. This hope, however, was destroyed by the doctor's telling him that while his religious convictions were very good, in his case they did not spell the ` },
        { text: `necessary vital spiritual experience`, highlight: 'pink' },
        { text: `.` }
      ]
    },
    { pageNum: "25" },
    ...
    { text: `In the following chapter, there appears an explanation of alcoholism, as we understand it, then a chapter addressed to the agnostic. Many who once were in this class are now among our members. Surprisingly enough, we find such convictions no great obstacle to a spiritual experience.` },
    {
      segments: [
        { text: `Further on, ` },
        { text: `clear-cut directions are given showing how we recovered`, highlight: 'pink' },
    ...
    {
      segments: [
        { text: `We hope no one will consider these self-revealing accounts in bad taste. Our hope is that many alcoholic men and women, desperately in need, will see these pages, and we believe that it is only by fully disclosing ourselves and our problems that they will be persuaded to say, ` },
        { text: `"Yes, I am one of them too; I must have this thing."`, highlight: 'blue' }
      ]
    }
  ]
};