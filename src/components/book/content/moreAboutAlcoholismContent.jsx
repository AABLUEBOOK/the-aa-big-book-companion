export const moreAboutAlcoholismContent = {
  paragraphs: [
    ...
    {
      segments: [
        { text: `MOST OF US have been unwilling to admit we were real alcoholics. No person likes to think he is bodily and mentally different from his fellows. Therefore, it is not surprising that our drinking careers have been characterized by countless vain attempts to prove we could drink like other people. The idea that somehow, someday he will control and enjoy his drinking is the ` },
        { text: `great obsession`, highlight: 'pink' },
        { text: ` of every abnormal drinker. The persistence of ` },
        { text: `this illusion`, highlight: 'pink' },
    ...
    {
      segments: [
        { text: `We alcoholics are men and women who have lost the ability to control our drinking. We know that no ` },
        { text: `real alcoholic`, highlight: 'pink' },
        { text: ` ever recovers control. All of us felt at times that we were regaining control, but such intervals—usually brief—were inevitably followed by still less control, which led in time to pitiful and incomprehensible demoralization. We are convinced to a man that alcoholics of our type are in the grip of a progressive illness. Over any considerable period we get worse, never better.` }
      ]
    },
    ...
    { pageNum: "33" },
    {
      segments: [
        { text: `` },
        { text: `A man of thirty was doing a great deal of spree drinking.`, highlight: 'pink' },
        { text: ` He was very nervous in the morning after these bouts and quieted himself with more liquor. He was ambitious to succeed in business, but saw that he would get nowhere if he drank at all. Once he started, he had no control whatever. He made up his mind that until he had been successful in business and had retired, he would not touch another drop. An exceptional man, he remained bone dry for twenty-five years and retired at the age of fifty-five, after a successful and happy business career. Then he fell victim to a belief which practically every alcoholic has—that his long period of sobriety and ` },
    ...
    {
      segments: [
        { text: `Our first example is a friend we shall call ` },
    ...
    {
      segments: [
        { text: `You may think this an extreme case. To us it is not far-fetched, for this kind of thinking has been characteristic of every single one of us. We have sometimes reflected more than ` },
        { text: `Jim`, highlight: 'pink' },
        { text: ` did upon the consequences. But there was always the ` },
    ...
    },
    {
      segments: [
        { text: `` },
        { text: `Our behavior is as absurd and incomprehensible with respect to the first drink as that of an individual with a passion, say, for jay-walking.`, highlight: 'pink' },
