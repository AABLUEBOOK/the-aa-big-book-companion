  ...
  paragraphs: [
    { pageNum: "30" },
    {
      segments: [
        ...
        { text: `real alcoholics`, highlight: 'pink' },
        { text: `. No person likes to think he is bodily and mentally different from his fellows. Therefore, it is not surprising that our drinking careers have been characterized by countless vain attempts to prove we could drink like other people. The idea that somehow, someday he will control and enjoy his drinking is the ` },
        { text: `great obsession`, highlight: 'pink' },
        { text: ` of every abnormal drinker. The persistence of this ` },
        { text: `illusion`, highlight: 'pink' },
        { text: ` is astonishing. Many pursue it into the gates of insanity or death.` }
      ]
    },
    {
      segments: [
        { text: `We learned that we had to fully concede to our innermost selves that we were alcoholics. This is the ` },
        { text: `first step`, highlight: 'pink' },
        { text: ` in recovery. The ` },
        { text: `delusion`, highlight: 'pink' },
    ...
    {
      segments: [
        { text: `Despite all we can say, many who are ` },
        { text: `real alcoholics`, highlight: 'pink' },
    ...
    { pageNum: "33" },
    {
      segments: [
        ...
        { text: ` was doing a great deal of spree drinking. He was very nervous in the morning after these bouts and quieted himself with more liquor. He was ambitious to succeed in business, but saw that he would get nowhere if he drank at all. Once he started, he had no control whatever. He made up his mind that until he had been successful in business and had retired, he would not touch another drop. An exceptional man, he remained bone dry for twenty-five years and retired at the age of fifty-five, after a successful and happy business career. Then he fell victim to a belief which practically every alcoholic has—that his long period of sobriety and ` },
        { text: `self-discipline`, highlight: 'pink' },
        { text: ` had qualified him to drink as other men. Out came his carpet slippers and a bottle. In two months he was in a hospital, puzzled and humiliated. He tried to regulate his drinking for a while, making several trips to the hospital meantime. Then, gathering all his forces, he attempted to stop altogether and found he could not. Every means of solving his problem which money could buy was at his disposal. Every attempt failed. Though a robust man at retirement, he went to pieces quickly and was dead within four years.` }
      ]
    },
    {
      segments: [
        { text: `This case contains a powerful lesson. Most of us have believed that if we remained sober for a long stretch, we could thereafter drink normally. But here is a man who at fifty-five years found he was just where he had left off at thirty. We have seen the truth demonstrated again and again: ` },
        { text: `"Once an alcoholic, always an alcoholic."`, highlight: 'pink' },
        { text: ` Commencing to drink after a period of sobriety, we are in a short time as bad as ever. If we are planning to stop drinking, there must be ` },
        { text: `no reservation`, highlight: 'pink' },
    ...
    { text: `Yet he got drunk again. We asked him to tell us exactly how it happened. This is his story: "I came to work on Tuesday morning. I remember I felt irritated that I had to be a salesman for a concern I once owned. I had a few words with the boss, but nothing serious. Then I decided to drive into the country and see one of my prospects for a car. On the way I felt hungry so I stopped at a roadside place where they have a bar. I had no intention of drinking. I just thought I would get a sandwich. I also had the notion that I might find a customer for a car at this place, which was familiar for I had been going to it for years. I had eaten there many times during the months I was sober. I sat down at a table and ordered a sandwich and a glass of milk. Still no thought of drinking. I ordered another sandwich and decided to have another glass of milk.` },
    {
      segments: [
        { text: `"` },
        { text: `Suddenly`, highlight: 'pink' },
        { text: ` the thought crossed my mind that if I were to put an ounce of whiskey in my milk it couldn't hurt me on a full stomach. I ordered a whiskey and poured it into the milk. I vaguely sensed I was not being any too smart, but felt reassured as I was taking the whiskey on a full stomach. The experiment went so well that I ordered another whiskey and poured it into more milk. That didn't seem to bother me so I tried another."` }
      ]
    },
    {
      segments: [
        { text: `Thus started one more journey to the asylum for ` },
        { text: `Jim`, highlight: 'pink' },
    ...
    { pageNum: "38" },
    {
      segments: [
        ...
        { text: `plain insanity`, highlight: 'pink' },
        { text: `. How can such a lack of proportion, of the ability to think straight, be called anything else?` }
      ]
    },
    {
      segments: [
        { text: `You may think this an extreme case. To us it is not far-fetched, for this kind of thinking has been characteristic of every single one of us. We have sometimes reflected more than Jim did upon the consequences. But there was always the ` },
        { text: `curious mental phenomenon`, highlight: 'pink' },
        { text: ` that parallel with our sound reasoning there inevitably ran some ` },
        { text: `insanely trivial excuse for taking the first drink`, highlight: 'pink' },
        { text: `. Our sound reasoning failed to hold us in check. ` },
        { text: `The insane idea won out.`, highlight: 'pink' },
        { text: ` Next day we would ask ourselves, in all earnestness and sincerity, how it could have happened.` }
      ]
    },
    {
      segments: [
        { text: `In some circumstances we have gone out deliberately to get drunk, feeling ourselves justified by nervousness, anger, worry, depression, jealousy or the like. But even in this type of beginning we are obliged to admit that our justification for a spree was ` },
        { text: `insanely insufficient`, highlight: 'pink' },
        { text: ` in the light of what always happened. We now see that when we began to drink deliberately, instead of casually, there was little serious or effective thought during the period of premeditation of what the terrific consequences might be.` }
      ]
    },
    {
      segments: [
        ...
        { text: `jay-walking`, highlight: 'pink' },
        { text: `. He gets a thrill out of skipping in front of fast-moving vehicles. He enjoys himself for a few years in spite of friendly warnings. Up to this point you would label him as a foolish chap having queer ideas of fun. Luck then deserts him and he is slightly injured several times in succession. You would expect him, if he were normal, to cut it out. Presently he is hit again and this time has a fractured skull. Within a week after leaving the hospital a fast-moving trolley car breaks his arm. He tells you he has decided to stop ` },
        { text: `jay-walking`, highlight: 'pink' },
        { text: ` for good, but in a few weeks he breaks both legs.` }
      ]
    },
    {
      segments: [
        { text: `On through the years this conduct continues, accompanied by his continual promises to be careful or to keep off the streets altogether. Finally, he can no longer work, his wife gets a divorce and he is held up to ridicule. He tries every known means to get the ` },
        { text: `jay-walking`, highlight: 'pink' },
        { text: ` idea out of his head. He shuts himself up in an asylum, hoping to mend his ways. But the day he comes out he races in front of a fire engine, which breaks his back. Such a man would be crazy, wouldn't he?` }
      ]
    },
    {
      segments: [
        { text: `You may think our illustration is too ridiculous. But is it? We, who have been through the wringer, have to admit if we substituted alcoholism for ` },
        { text: `jay-walking`, highlight: 'pink' },
        { text: `, the illustration would fit us exactly. However intelligent we may have been in other respects, where alcohol has been involved, we have been ` },
        { text: `strangely insane`, highlight: 'pink' },
    ...
    {
      segments: [
        { text: `That may be true of certain nonalcoholic people who, though drinking foolishly and heavily at the present time, are able to stop or moderate, because their brains and bodies have not been damaged as ours were. But the actual or potential alcoholic, with hardly an exception, will be ` },
        { text: `absolutely unable to stop drinking on the basis of self-knowledge`, highlight: 'pink' },
    ...
    { pageNum: "40" },
    {
      segments: [
        ...
        { text: ` His income is good, he has a fine home, is happily married and the father of promising children of college age. He has so attractive a personality that he makes friends with everyone. If ever there was a successful business man, it is ` },
        { text: `Fred`, highlight: 'pink' },
        { text: `. To all appearance he is a stable, well balanced individual. Yet, he is alcoholic. We first saw ` },
        { text: `Fred`, highlight: 'pink' },
        { text: ` about a year ago in a hospital where he had gone to recover from a bad case of jitters. It was his first experience of this kind, and he was much ashamed of it. Far from admitting he was an alcoholic, he told himself he came to the hospital to rest his nerves. The doctor intimated strongly that he might be worse than he realized. For a few days he was depressed about his condition. He made up his mind to quit drinking altogether. It never occurred to him that perhaps he could not do so, in spite of his character and standing. ` },
        { text: `Fred`, highlight: 'pink' },
        { text: ` would not believe himself an alcoholic, much less accept a spiritual remedy for his problem. We told him what we knew about alcoholism. He was interested and conceded that he had some of the symptoms, but he was a long way from admitting that he could do nothing about it himself. He was positive that this humiliating experience, plus the ` },
        { text: `knowledge`, highlight: 'pink' },
        { text: ` he had acquired, would keep him sober the rest of his life. ` },
    ...
    {
      segments: [
        { text: `"I went to my hotel and leisurely dressed for dinner. ` },
        { text: `As I crossed the threshold of the dining room, the thought came to mind that it would be nice to have a couple of cocktails with dinner. That was all. Nothing more.`, highlight: 'pink' },
        { text: ` I ordered a cocktail and my meal. Then I ordered another cocktail. After dinner I decided to take a walk. When I returned to the hotel it struck me a highball would be fine before going to bed, so I stepped into the bar and had one. I remember having several more that night and plenty next morning. I have a shadowy recollection of being in an airplane bound for New York, and of finding a friendly taxicab driver at the landing field instead of my wife. The driver escorted me about for several days. I know little of where I went or what I said and did. Then came the hospital with unbearable mental and physical suffering.` }
      ]
    },
    {
      segments: [
        { text: `"As soon as I regained my ability to think, I went carefully over that evening in Washington. ` },
        { text: `Not only had I been off guard, I had made no fight whatever against the first drink. This time I had not thought of the consequences at all.`, highlight: 'pink' },
        { text: ` I had commenced to drink as carelessly as though the cocktails were ginger ale. I now remembered what my alcoholic friends had told me, how they prophesied that if I had an ` },
        { text: `alcoholic mind`, highlight: 'pink' },
        { text: `, the time and place would come—I would drink again. They had said that though I did raise a defense, it would one day give way before some trivial reason for having a drink. Well, just that did happen and more, for what I had learned of alcoholism did not occur to me at all. I knew from that moment that I had an ` },
        { text: `alcoholic mind`, highlight: 'pink' },
        { text: `. I saw that will power and ` },
    ...
    {
      segments: [
        { text: `Fred's story`, highlight: 'pink' },
        { text: ` speaks for itself. We hope it strikes home to thousands like him. He had felt only the first nip of the wringer. Most alcoholics have to be pretty badly mangled before they really commence to solve their problems.` }
      ]
    },
    {
      segments: [
    ...
    },
    {
      segments: [
        { text: `Once more: ` },
        { text: `The alcoholic at certain times has no effective mental defense against the first drink.`, highlight: 'pink' },
        { text: ` Except in a few rare cases, neither he nor any other human being can provide such a defense. His defense must come from a Higher Power.` }
      ]
    }
  ]
};