export const howItWorksContent = {
  paragraphs: [
    ...
    {
      segments: [
        { text: `Half measures availed us nothing. ` },
        { text: `We stood at the turning point. We asked His protection and care with complete abandon.`, highlight: 'green' }
      ]
    },
    ...
    { text: `(a) That we were alcoholic and could not manage our own lives.` },
    { text: `(b) That probably no human power could have relieved our alcoholism.` },
    { text: `(c) That God could and would if He were sought.` },
    ...
    { text: `Selfishness—self-centeredness! That, we think, is the root of our troubles. Driven by a hundred forms of fear, self-delusion, self-seeking, and self-pity, we step on the toes of our fellows and they retaliate. Sometimes they hurt us, seemingly without provocation, but we invariably find that at some time in the past we have made decisions based on self which later placed us in a position to be hurt.` },
    {
      segments: [
        ...
        { text: `God makes that possible.`, highlight: 'blue' },
    ...
    { text: `This is the how and why of it. First of all, we had to quit playing God. It didn't work. Next, we decided that hereafter in this drama of life, God was going to be our Director. He is the Principal; we are His agents. He is the Father, and we are His children. Most good ideas are simple, and this concept was the keystone of the new and triumphant arch through which we passed to freedom.`, highlight: 'blue' },
    { pageNum: "63" },
    ...
    { text: `I'm resentful at: Mr. Brown — The Cause: His attention to my wife. Told my wife of my mistress. Brown may get my job at the office. — Affects my: Sex relations. Self-esteem (fear). Security. Self-esteem (fear).` },
    ...
    {
      segments: [
        { text: `In this way we tried to shape a sane and sound ideal for our future sex life. We subjected each relation to this test—was it selfish or not? ` },
        { text: `We asked God to mold our ideals and help us to live up to them.`, highlight: 'green' },
        { text: ` We remembered always that our sex powers were God-given and therefore good, neither to be used lightly or selfishly nor to be despised and loathed.` }
      ]
    },
    {
      segments: [
        { text: `Whatever our ideal turns out to be, we must be willing to grow toward it. We must be willing to make amends where we have done harm, provided that we do not bring about still more harm in so doing. In other words, we treat sex as we would any other problem. ` },
