  ...
  paragraphs: [
    ...
    },
    {
      segments: [
        ...
        { text: `If you have decided you want what we have and are willing to go to any length to get it—then you are ready to take certain steps.`, highlight: 'pink' }
      ]
    },
    ...
    { text: `Our description of the alcoholic, the chapter to the agnostic, and our personal adventures before and after make clear three pertinent ideas:` },
    {
      segments: [
        { text: `` },
        { text: `(a) That we were alcoholic and could not manage our own lives.`, highlight: 'pink' }
      ]
    },
    {
      segments: [
        { text: `` },
        { text: `(b) That probably no human power could have relieved our alcoholism.`, highlight: 'pink' }
      ]
    },
    {
      segments: [
        { text: `` },
        { text: `(c) That God could and would if He were sought.`, highlight: 'pink' }
      ]
    },
    {
      segments: [
    ...
    },
    {
      segments: [
        { text: `` },
        { text: `The first requirement`, highlight: 'pink' },
        { text: ` is that we be convinced that any life run on self-will can hardly be a success. On that basis we are almost always in collision with something or somebody, even though our motives are good. Most people try to live by self-propulsion. Each person is like ` },
        { text: `an actor`, highlight: 'pink' },
    ...
    { pageNum: "62" },
    {
      segments: [
        ...
        { text: ` That, we think, is the root of our troubles. ` },
        { text: `Driven by a hundred forms of fear, self-delusion, self-seeking, and self-pity, we step on the toes of our fellows and they retaliate.`, highlight: 'pink' },
    ...
    },
    {
      segments: [
        { text: `` },
        { text: `This is the how and why of it. First of all, we had to quit playing God. It didn't work. Next, we decided that hereafter in this drama of life, God was going to be our Director. He is the Principal; we are His agents. He is the Father, and we are His children.`, highlight: 'pink' },
        { text: ` Most good ideas are simple, and this concept was the ` },
        { text: `keystone`, highlight: 'pink' },
        { text: ` of the new and triumphant arch through which we passed to freedom.` }
      ]
    },
    { pageNum: "63" },
    {
    ...
    { pageNum: "64" },
    {
      segments: [
        { text: `` },
        { text: `Next we launched out on a course of vigorous action, the first step of which is a personal housecleaning,`, highlight: 'pink' },
        { text: ` which many of us had never attempted. Though our decision was a vital and crucial step, it could have little permanent effect unless at once followed by a strenuous effort to face, and to be rid of, the things in ourselves which had been blocking us. Our liquor was but a symptom. So we had to get down to causes and conditions.` }
      ]
    },
    {
      segments: [
    ...
    },
    {
      segments: [
        { text: `` },
        { text: `We did exactly the same thing with our lives. We took stock honestly. First, we searched out the flaws in our make-up which caused our failure.`, highlight: 'pink' },
        { text: ` Being convinced that self, manifested in various ways, was what had defeated us, we considered its common manifestations.` }
      ]
    },
    {
      segments: [
    ...
    { pageNum: "65" },
    { text: `(including sex) were hurt or threatened. So we were sore. We were "burned up."` },
    {
      segments: [
        { text: `` },
        { text: `On our grudge list we set opposite each name our injuries. Was it our self-esteem, our security, our ambitions, our personal, or sex relations, which had been interfered with?`, highlight: 'pink' }
      ]
    },
    {
      segments: [
        { text: `` },
        { text: `We were usually as definite as this example:`, highlight: 'pink' }
      ]
    },
    {
      segments: [
        { text: `` },
        { text: `I'm resentful at:`, highlight: 'pink' },
        { text: ` Mr. Brown — ` },
        { text: `The Cause:`, highlight: 'pink' },
        { text: ` His attention to my wife. Told my wife of my mistress. Brown may get my job at the office. — ` },
        { text: `Affects my:`, highlight: 'pink' },
        { text: ` Sex relations. Self-esteem (` },
    ...
    { text: `I'm resentful at: Mrs. Jones — The Cause: She's a nut—she snubbed me. She committed her husband for drinking. He's my friend. She's a gossip. — Affects my: Personal relationship. Self-esteem (fear).` },
    { text: `I'm resentful at: My employer — The Cause: Unreasonable—Unjust—Overbearing—Threatens to fire me for drinking and padding my expense account. — Affects my: Self-esteem (fear). Security.` },
    { text: `I'm resentful at: My wife — The Cause: Misunderstands and nags. Likes Brown. Wants house put in her name. — Affects my: Pride—Personal sex relations—Security (fear).` },
    { pageNum: "66" },
    {
      segments: [
        { text: `` },
        { text: `We went back through our lives. Nothing counted but thoroughness and honesty. When we were finished we considered it carefully.`, highlight: 'pink' },
        { text: ` The first thing apparent was that this world and its people were often quite wrong. To conclude that others were wrong was as far as most of us ever got. The usual outcome was that people continued to wrong us and we stayed sore. Sometimes it was remorse and then we were sore at ourselves. But the more we fought and tried to have our own way, the worse matters got. As in war, the victor only seemed to win. Our moments of triumph were short-lived.` }
      ]
    },
    {
      segments: [
        { text: `It is plain that a life which includes deep resentment leads only to futility and unhappiness. To the precise extent that we permit these, do we squander the hours that might have been worth while. ` },
        { text: `But with the alcoholic, whose hope is the maintenance and growth of a spiritual experience, this business of resentment is infinitely grave.`, highlight: 'pink' },
        { text: ` We found that it is fatal. For when harboring such feelings we shut ourselves off from the sunlight of the Spirit. The insanity of alcohol returns and we drink again. And with us, to drink is to die.` }
      ]
    },
    { text: `If we were to live, we had to be free of anger. The grouch and the brainstorm were not for us. They may be the dubious luxury of normal men, but for alcoholics these things are poison.` },
    {
      segments: [
        { text: `` },
        { text: `We turned back to the list, for it held the key to the future. We were prepared to look at it from an entirely different angle.`, highlight: 'pink' },
        { text: ` We began to see that the world and its people really dominated us. In that state, the wrong-doing of others, fancied or real, had power to actually kill. How could we escape? We saw that these resentments must be mastered, but how? We could not wish them away any more than alcohol.` }
      ]
    },
    { pageNum: "67" },
    {
    ...
    },
    {
      segments: [
        ...
        { text: `fear`, highlight: 'pink' },
        { text: `" is bracketed alongside the difficulties with Mr. Brown, Mrs. Jones, the employer, and the wife. This short word somehow touches about every aspect of our lives. It was an evil and corroding thread; the fabric of our existence was shot through with it. It set in motion trains of circumstances which brought us misfortune we felt we didn't deserve. But did not we, ourselves, set the ball rolling? Sometimes` }
      ]
    },
    { pageNum: "68" },
    { text: `we think fear ought to be classed with stealing. It seems to cause more trouble.` },
    {
      segments: [
        { text: `` },
        { text: `We reviewed our fears thoroughly. We put them on paper, even though we had no resentment in connection with them. We asked ourselves why we had them. Wasn't it because self-reliance failed us?`, highlight: 'pink' },
        { text: ` Self-reliance was good as far as it went, but it didn't go far enough. Some of us once had great self-confidence, but it didn't fully solve the ` },
    ...
    },
    {
      segments: [
        { text: `` },
        { text: `Now about sex. Many of us needed an overhauling there. But above all, we tried to be sensible on this question.`, highlight: 'pink' },
        { text: ` It's so easy to get way off the track. Here we find human opinions running to extremes—absurd extremes, perhaps. One set of voices cry that sex is a lust of our lower nature, a base necessity of procreation. Then we have the voices who cry for sex and more sex; who bewail the institution of marriage; who think that most of the troubles of the race are traceable to sex causes. They think we do not have enough of it, or that it isn't the right kind. They see its significance everywhere. One school would allow man no flavor for his fare and the other would have us all on a straight pepper diet. We want to stay out of this controversy. We do not want to be the arbiter of anyone's sex conduct. We all have ` },
        { text: `sex problems.`, highlight: 'pink' },
        { text: ` We'd hardly be human if we didn't. ` },
        { text: `What can we do about them?`, highlight: 'pink' }
      ]
    },
    { pageNum: "69" },
    {
      segments: [
        { text: `` },
        { text: `We reviewed our own conduct over the years past. Where had we been selfish, dishonest, or inconsiderate? Whom had we hurt? Did we unjustifiably arouse jealousy, suspicion or bitterness? Where were we at fault, what should we have done instead? We got this all down on paper and looked at it.`, highlight: 'pink' }
      ]
    },
    {
      segments: [
    ...
    {
      segments: [
        { text: `God alone can judge our ` },
        { text: `sex situation.`, highlight: 'pink' },
        { text: ` Counsel with persons is often desirable, but we let God be the final judge. We realize that some people are as fanatical about sex as others are loose. We avoid hysterical thinking or advice.` }
      ]
    },
    { pageNum: "70" },
    {
