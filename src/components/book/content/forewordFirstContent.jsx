export const forewordFirstContent = {
  highlights: [],
  tabs: [],
  paragraphs: [
    {
      segments: [
        ...
        { text: ` from a seemingly hopeless state of mind and body. To show other alcoholics ` },
        { text: `precisely how we have recovered`, highlight: 'pink' },
        { text: ` is the main purpose of this book.` }
      ]
    },
    {
    ...
    {
      text: `We shall be interested to hear from those who are getting results from this book, especially from those who have commenced work with other alcoholics. We should like to be helpful to such cases.`
    },
    {
