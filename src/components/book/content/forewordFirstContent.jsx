  ...
  paragraphs: [
    { pageNum: "xiii" },
    {
      segments: [
        ...
        { text: ` from a seemingly hopeless state of mind and body. ` },
        { text: `To show other alcoholics precisely how we have recovered is the main purpose of this book,`, highlight: 'pink' }
      ]
    },
    {
