  ...
  paragraphs: [
    ...
    { pageNum: "xxviii" },
    {
      segments: [
        ...
        { text: ` is limited to this class and never occurs in the average temperate drinker. These ` },
        { text: `allergic types`, highlight: 'pink' },
        { text: ` can never safely use alcohol in any form at all; and once having formed the habit and found they cannot break it, once having lost their self-confidence, their reliance upon things human, their problems pile up on them and become astonishingly difficult to solve.` }
      ]
    },
    ...
    {
      segments: [
        { text: `Men and women drink essentially because they like the ` },
        { text: `effect produced by alcohol.`, highlight: 'pink' },
        { text: ` The sensation is so elusive that, while they admit it is injurious, they cannot after a time differentiate the true from the false. To them, their alcoholic life seems the only normal one. They are ` },
        { text: `restless, irritable and discontented,`, highlight: 'pink' },
    ...
    { text: `There are many situations which arise out of the phenomenon of craving which cause men to make the supreme sacrifice rather than continue to fight.` },
    {
      segments: [
        { text: `The ` },
        { text: `classification of alcoholics`, highlight: 'pink' },
        { text: ` seems most difficult, and in much detail is outside the scope of this book. There are, of course, the psychopaths who are emotionally unstable. We are all familiar with this ` },
        { text: `type.`, highlight: 'pink' },
        { text: ` They are always "going on the wagon for keeps." They are over-remorseful and make many resolutions, but never a decision.` }
      ]
    },
    {
      segments: [
        { text: `There is the ` },
        { text: `type`, highlight: 'pink' },
        { text: ` of man who is unwilling to admit that he cannot take a drink. He plans various ways of drinking. He changes his brand or his environment. There is the ` },
        { text: `type`, highlight: 'pink' },
        { text: ` who always believes that after being entirely free from alcohol for a period of time he can take a drink without danger. There is the manic-depressive ` },
        { text: `type,`, highlight: 'pink' },
        { text: ` who is, perhaps, the least understood by his friends, and about whom a whole chapter could be written.` }
      ]
    },
    {
      segments: [
        { text: `Then there are ` },
        { text: `types`, highlight: 'pink' },
        { text: ` entirely normal in every respect except in the effect alcohol has upon them. They are often able, intelligent, friendly people.` }
      ]
    },
    {
      segments: [
    ...
    { text: `This immediately precipitates us into a seething caldron of debate. Much has been written pro and con, but among physicians, the general opinion seems to be that most chronic alcoholics are doomed.` },
    { pageNum: "xxxi" },
    {
      segments: [
        { text: `` },
