export const doctorsOpinionContent = {
  highlights: [],
  tabs: [
    { label: "PHYSICAL\nALLERGY", color: "yellow", position: 5 },
    { label: "ALLERGY", color: "blue", position: 32 },
    { label: "PHENOMENON\nOF CRAVING", color: "pink", position: 38 },
    { label: "EFFECTS BY\nALCOHOL", color: "blue", position: 50 },
    { label: "RESTLESS\nIRRITABLE\nDISCONTENT", color: "yellow", position: 60 },
    { label: "5 TYPES OF\nACOHOLICS", color: "pink", position: 72 }
  ],
  paragraphs: [
    {
    ...
    {
      text: `What is the solution? Perhaps I can best answer this by relating one of my experiences.`
    },
    {
