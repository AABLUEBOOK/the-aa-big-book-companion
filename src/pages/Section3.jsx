...
const CHAPTERS = [
  { id: "we-agnostics", title: "We Agnostics", pageNum: "44", chapter: 4 },
  { id: "how-it-works", title: "How It Works", pageNum: "58", chapter: 5 }
];
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
          <div className="max-w-4xl mx-auto space-y-12">
            {CHAPTERS.map((chapter) => (
              ...
              >
                <ChapterContent chapter={chapter} sectionRoute="Section3" />
              </div>
            ))}
          </div>
        </main>
