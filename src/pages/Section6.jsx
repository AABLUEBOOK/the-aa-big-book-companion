...
const CHAPTERS = [
  { id: "to-wives", title: "To Wives", pageNum: "104", chapter: 8 },
  { id: "family-afterward", title: "The Family Afterward", pageNum: "122", chapter: 9 }
];
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
          <div className="max-w-4xl mx-auto space-y-12">
            {CHAPTERS.map((chapter) => (
              ...
              >
                <ChapterContent chapter={chapter} sectionRoute="Section6" />
              </div>
            ))}
          </div>
        </main>
