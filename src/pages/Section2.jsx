...
const CHAPTERS = [
  { id: "bills-story", title: "Bill's Story", pageNum: "1", chapter: 1 },
  { id: "there-is-solution", title: "There Is a Solution", pageNum: "17", chapter: 2 },
  { id: "more-about-alcoholism", title: "More About Alcoholism", pageNum: "30", chapter: 3 }
];
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
          <div className="max-w-4xl mx-auto space-y-12">
            {CHAPTERS.map((chapter) => (
              ...
              >
                <ChapterContent chapter={chapter} sectionRoute="Section2" />
              </div>
            ))}
          </div>
        </main>
